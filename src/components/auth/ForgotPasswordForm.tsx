        ...
        <div className="w-full max-w-md mx-auto">
          <div className="mb-12 text-center lg:text-left">
            ...
            <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">
              Saisissez l&apos;email de votre compte pour recevoir un lien de réinitialisation.
            </p>
          </div>
          ...
          {success ? (
            <div className="space-y-6">
              ...
              <p className="text-[10px] font-bold text-gray-400 ml-1">
                Vérifiez vos courriers indésirables si vous ne voyez rien dans quelques minutes.
              </p>
              <Link
                href="/signin"
