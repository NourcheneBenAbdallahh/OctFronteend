...
function getEntrepotLabel(lot: Lot) {
  return lot.entrepot?.nom || lot.entrepot?.name || "Non défini";
}

export default function LotCard({ lot, compact = false, onView }: Props) {
  return (
      ...
      <div className="flex-1 space-y-8">
        ...
        <div className="pt-6 border-t border-gray-50">
           <div className="flex items-center gap-2 mb-1">
             ...
             <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Entrepôt</span>
           </div>
           <div className="text-[12px] font-[900] text-[#1C2434] uppercase break-words">
